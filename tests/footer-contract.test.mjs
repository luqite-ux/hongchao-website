...
const footerSource = read("web/components/footer.tsx")
const ownerEvidence = read("web/app/about/page.tsx")
const exactCompanyName = "Suzhou Hongchao Automation Equipment Co., Ltd."
...
test('footer renders the verified legal owner with a runtime year and one terminal period', () => {
  ...
  assert.equal(copyrightSource.includes("Hongchao. All rights reserved."), false)
})
