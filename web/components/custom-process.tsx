...
const steps = [
  ...
  { number: "02", title: "Analysis", description: "We analyze your parts and production environment thoroughly.", icon: FileSearch },
  { number: "03", title: "Design", description: "Custom solution design with 3D modeling and simulation.", icon: PenTool },
  { number: "04", title: "Manufacturing", description: "Precision manufacturing in our state-of-the-art facility.", icon: Factory },
  { number: "05", title: "Delivery", description: "Installation, testing, and ongoing technical support.", icon: PackageCheck },
]
              ...
              {steps.map((step, index) => (
                <div key={step.number} className="relative">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h3 className="mt-6 text-lg font-semibold text-slate-800">{step.title}</h3>
